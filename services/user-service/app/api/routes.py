...
async def update_user_location(email: str, data: UpdateUserLocation, db: AsyncSession = Depends(get_db)):
    return await UserCommandService(db).update_user_location(email, data)
